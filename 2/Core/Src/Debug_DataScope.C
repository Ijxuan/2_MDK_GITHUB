...
//float Data=3;
//unsigned char DataScope_OutPut_Buffer[42] = { 9 };	   //串口发送缓冲区
...
//printf("%d %d %d %d",DataScope_OutPut_Buffer[0],DataScope_OutPut_Buffer[1],DataScope_OutPut_Buffer[2],DataScope_OutPut_Buffer[3]
////);
//printf("1%d 22%d 3%d 4%d 5%d 6%d",DataScope_OutPut_Buffer[0],DataScope_OutPut_Buffer[1],DataScope_OutPut_Buffer[2],DataScope_OutPut_Buffer[3],DataScope_OutPut_Buffer[4]
//,DataScope_OutPut_Buffer[5]
//);
...
//printf("%s",DataScope_OutPut_Buffer
//);
...
//	{
////		HAL_UART_Transmit(&huart6,&DataScope_OutPut_Buffer[i],1,0xff);  
//		tx2Buf[i]=DataScope_OutPut_Buffer[i];
////		HAL_UART_Transmit_DMA(&huart6,&DataScope_OutPut_Buffer[i],1);
//	}
	
			HAL_UART_Transmit_DMA(&huart6,&DataScope_OutPut_Buffer[0],Send_Count);
